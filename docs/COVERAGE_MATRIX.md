...
| Dimension | Rows | Ids |
| --- | --- | --- |
| unsupported diagnosis | 5 | EVAL-003, EVAL-016, EVAL-017, EVAL-020, RT-03 |
| conflicting records | 3 | EVAL-007, EVAL-029, RT-08 |
| stale policy | 0 | none |
| prompt injection | 4 | EVAL-010, EVAL-024, RT-01, RT-04 |
| missing evidence | 4 | EVAL-005, EVAL-014, EVAL-021, EVAL-027 |
| tool failure | 1 | RT-15 |
| privilege escalation | 8 | EVAL-006, EVAL-011, EVAL-019, RT-02, RT-06, RT-07, RT-10, RT-16 |
| other/core | 21 | EVAL-001, EVAL-002, EVAL-004, EVAL-008, EVAL-009, EVAL-012, EVAL-013, EVAL-015, EVAL-018, EVAL-022, EVAL-023, EVAL-025, EVAL-026, EVAL-028, EVAL-030, RT-05, RT-09, RT-11, RT-12, RT-13, RT-14 |
...
| Root-cause agreement with prepared ground truth | 0 of 3 | `root_cause_vs_prepared_ground_truth` FAIL on all three runs: planner said MULTI_FACTOR (v6, v9) and USAGE_SUPPORTED (v10) against a prepared label of NO_SUPPORTED_ROOT_CAUSE. This is the label mismatch the reviewer cites. Unresolved |
| Deterministic checks | v6 6 of 13, v9 6 of 13, v10 12 of 13 | Dataset D. The 14 preregistered acceptance criteria in `docs/FINAL_RUN_RESULT_2026-09-20.md` are a separate, run-specific list; v10 passed 14 of 14 there |
...
| Root-cause label mismatch | Decide whether the prepared label or the planner vocabulary is wrong, fix one, re-run the check locally | $0 |
| Stale policy, zero rows | Add one case whose cited policy has a superseded version in `evaluation/policy/policy_catalog.json` | $0 to prepare, about $0.09 to run |
| Tool failure, no real rows | Add one case where the synthetic data adapter returns an error for one evidence source | $0 to prepare, about $0.09 to run |
